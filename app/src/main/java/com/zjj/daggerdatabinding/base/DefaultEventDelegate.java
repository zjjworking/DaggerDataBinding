...
public class DefaultEventDelegate implements EventDelegate {
    private BaseNewBindingAdapter adapter;
    private EventFooter footer ;

    private BaseNewBindingAdapter.OnLoadMoreListener onLoadMoreListener;
    ...
    public DefaultEventDelegate(BaseNewBindingAdapter adapter) {
    ...
    @Override
    public void setMore(View view, BaseNewBindingAdapter.OnLoadMoreListener listener) {
    ...
    private class EventFooter implements BaseNewBindingAdapter.ItemView {
