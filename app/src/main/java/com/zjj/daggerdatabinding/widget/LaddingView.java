...
public class LaddingView extends View{
    float mWidth = 0f;
    float mHight = 0f;
    ...
    public LaddingView(Context context) {
        this(context, null);
    }

    public LaddingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LaddingView(Context context, AttributeSet attrs, int defStyleAttr) {
